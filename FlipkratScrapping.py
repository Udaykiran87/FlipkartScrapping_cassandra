            ...
            for link in self.getProductLinks():
                ...
                if review_count <= expected_review:
                    ...
                    if locator.getCustomerName() in self.driver.page_source:
                        ...
                        print(product_name)
                        query = " WHERE product_name='"+product_name+"' ALLOW FILTERING;"
                        db_search = cassandraClient.findfirstRecord(keyspace_name=cred['keyspace'],
                                                                table_name=searchString.replace("-","_"),
                                                                query=query)
                        print(db_search)
                        ...
                        while count <= total_review_page:
                            ...
                            if len(ratings) > 0:
                                for i in range(0, len(ratings)):
                                    ...
                                    cassandraClient.insertRecord(keyspace_name=cred['keyspace'],
                                                             table_name=searchString.replace("-","_"),
                                                             record=result)
                                    print(result)
